...
def dataPointGenerator(outputFile="dataPoints.npy"):
    ...
    theta1 = np.arange(start=0, stop=180, step=10) * (math.pi/180)
    theta2 = np.arange(start=0, stop=180, step=10) * (math.pi/180)
    theta3 = np.arange(start=0, stop=90, step=10) * (math.pi/180)
